      ...
      <main className="container mx-auto px-6 py-10 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          <div className="space-y-6">
            ...
            <div className="p-6 rounded-3xl bg-white dark:bg-gradient-to-br dark:from-blue-500/10 dark:to-purple-500/5 border border-zinc-200 dark:border-blue-500/20 backdrop-blur-sm shadow-sm dark:shadow-none">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3 mb-8">
                {[
                  ...
                  <div key={i} className="p-4 rounded-2xl bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/5 hover:border-zinc-300 dark:hover:bg-white/10 transition-colors shadow-sm dark:shadow-none">
